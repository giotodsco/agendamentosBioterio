...
try {
    ...
    if (count($agendamentos) > 0) {
        echo "<table>";
        echo "<thead><tr><th>ID</th><th>Nome</th><th>Email</th><th>É Aluno?</th><th>Data</th><th>Hora</th><th>Registro</th><th>Status</th></tr></thead>";
        echo "<tbody>";
        foreach ($agendamentos as $agendamento) {
            ...
            echo "<td>" . htmlspecialchars($agendamento['email']) . "</td>"; // Exibindo o email
            ...
            echo "<td>" . htmlspecialchars(ucfirst($agendamento['status'])) . "</td>"; // Exibindo o status
            echo "</tr>";
        }
        echo "</tbody>";
        echo "</table>";
