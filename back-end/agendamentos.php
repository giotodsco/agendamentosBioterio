...
try {
    ...
    if (count($agendamentos) > 0) {
        echo "<table>";
        echo "<thead><tr><th>ID</th><th>Nome</th><th>Origem</th><th>É Aluno?</th><th>Data</th><th>Hora</th><th>Registro</th></tr></thead>";
        echo "<tbody>";
        foreach ($agendamentos as $agendamento) {
            ...
            echo "<td>" . htmlspecialchars($agendamento['origem']) . "</td>";
